	...
	<div class="col-md-12">
		<div class="nav-tabs-custom">
			<div class="tab-content">
				<form id="frmInsertarCargo" action="{{url('cargo/insertar')}}" method="post">
					<div class="tab-pane active" id="tab_1-1">
						...
						<div class="row">
							<div class="col-md-12">
								{{csrf_field()}}
								<input type="button" class="btn btn-primary pull-right" value="Registrar datos ingresados" onclick="enviarFrmInsertarCargo();">
							</div>
						</div>
					</div>
				</form>
...
<script>
	$(function()
	{
		$('#frmInsertarCargo').formValidation(
		{
			framework : 'bootstrap',
	...
	function enviarFrmInsertarCargo()
	{
		var isValid=null;

		$('#frmInsertarCargo').data('formValidation').resetForm();
		$('#frmInsertarCargo').data('formValidation').validate();

		isValid=$('#frmInsertarCargo').data('formValidation').isValid();
