...
@section('titulo', 'Listar oficinas')
@section('subTitulo', '...')
										...
										@foreach($listaTOficina as $value)
											<tr class="elementoBuscar">
												...
												<td class="text-right">
													...
													<span class="btn btn-default btn-xs glyphicon glyphicon-user" data-toggle="tooltip" data-placement="left" title="Gestionar personal" onclick="dialogoAjax('dialogoGeneral', null, '{{$value->nombre}} (Gestión de personal)', { _token : '{{csrf_token()}}', codigoOficina : '{{$value->codigoOficina}}' }, '{{url('usuariotoficina/gestionar')}}', 'POST', null, null, false, true);"></span>
												</td>
											</tr>
										@endforeach
									</tbody>
