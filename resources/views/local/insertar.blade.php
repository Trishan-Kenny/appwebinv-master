...
@section('titulo', 'Registrar local')
@section('subTitulo', '...')
	...
	<div class="col-md-12">
		<div class="nav-tabs-custom">
			<div class="tab-content">
				<form id="frmInsertarLocal" action="{{url('local/insertar')}}" method="post">
					<div class="tab-pane active" id="tab_1-1">
						<div class="row">
							...
							<div class="form-group col-md-4">
								...
								<select id="selectCodigoDistrito" name="selectCodigoDistrito" class="form-control selectStatic" style="width: 100%;"></select>
							</div>
							<div class="form-group col-md-4">
						...
						<div class="row">
							<div class="col-md-12">
								{{csrf_field()}}
								<input type="button" class="btn btn-primary pull-right" value="Registrar datos ingresados" onclick="enviarFrmInsertarLocal();">
							</div>
						</div>
					</div>
				</form>
...
<script>
	$(function()
	{
		$('#frmInsertarLocal').formValidation(
		{
			framework : 'bootstrap',
	...
	function enviarFrmInsertarLocal()
	{
		var isValid=null;

		$('#frmInsertarLocal').data('formValidation').resetForm();
		$('#frmInsertarLocal').data('formValidation').validate();

		isValid=$('#frmInsertarLocal').data('formValidation').isValid();
